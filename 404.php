...
<head>
  ...
  <link href="assets/css/erro404.css" rel="stylesheet">
...
<div class="main-error-page">
  ...
  <h1 class="error-title">
    Opa! <br>Algo deu errado :(
  </h1>
  <h2 class="error-subtitle"><?php echo $erro; ?></h2>
  <a href="home">&larr; Resolveu? Volte para Painel!</a>

 
</div>


  <script src="assets/js/erro404.js"></script>
</body>
</html>
